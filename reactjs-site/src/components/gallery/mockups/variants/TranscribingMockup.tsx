...
import { TranscriptionBox, ResponseBox, ThinkingDots } from '../shared/TranscriptionBox';

export function TranscribingMockup() {
  return (
    <IcMain>
      <Winbar plan="Pro" />
      <div className="flex items-center justify-between px-3 pb-2.5 gap-2">
        <div className="flex items-center gap-2.5 flex-shrink-0">
          <BotBox />
          <Badge variant="time">🕐 118m</Badge>
          <Badge variant="session">⏱ 02:15</Badge>
          <ScreenToggle />
        </div>
      ...
      <Section flex>
        <SectionHeader
          ...
          labelKey="ic.copilot"
          spin
          badge={<ResponseBadge kind="thinking" labelKey="ic.thinkingBadge" />}
        />
        <ResponseBox>
          <ThinkingDots labelKey="ic.generating" />
        </ResponseBox>
      </Section>
    </IcMain>
  );
