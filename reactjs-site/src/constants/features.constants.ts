...
export const FEATURES: readonly FeatureItem[] = [
  { icon: '🎯', titleKey: 'features.0.title', descKey: 'features.0.desc', tagKey: 'features.0.tag' },
  { icon: '📊', titleKey: 'features.1.title', descKey: 'features.1.desc', tagKey: 'features.1.tag' },
  { icon: '🧭', titleKey: 'features.2.title', descKey: 'features.2.desc', tagKey: 'features.2.tag' },
  ...
  { icon: '📈', titleKey: 'features.6.title', descKey: 'features.6.desc', tagKey: 'features.6.tag' },
