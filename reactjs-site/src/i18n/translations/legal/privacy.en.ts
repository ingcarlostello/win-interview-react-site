...
export const privacyEn: TranslationDict = {
  ...
  'sec1.text':
    'The data controller for your personal data is Carlos Tello - win interview, located in Colombia. For any privacy inquiries you can write to us at legal@wininterview.xyz.',
  'sec2.title': '2. Data we collect',
  'sec2.intro': 'To provide you with the Service we may process the following data:',
  'sec2.1':
    'Account data: name, email address, and user identifier provided by Clerk during registration.',
  'sec2.2':
  ...
  'sec5.title': '5. Providers and international transfers',
  'sec5.intro':
    'To operate wininterview we work with external providers that may be located outside Colombia:',
  ...
  'sec8.2': 'Rectify inaccurate or incomplete data.',
  'sec8.3': 'Request deletion of your data.',
  'sec8.4': 'Object to processing or request its restriction.',
  'sec8.5': 'Revoke your consent at any time.',
  'sec8.6': 'File a complaint with the competent data protection authority.',
  'sec8.text_2':
    'To exercise these rights, send your request to legal@wininterview.xyz clearly stating your request and proving your identity.',
  'sec9.title': '9. Cookies and similar technologies',
  'sec9.text':
    'Currently wininterview does not use its own tracking cookies. Authentication or payment providers may use technical cookies necessary for their operation. If in the future we implement analytical or marketing cookies, we will update this policy and request your consent where required.',
  'sec10.title': '10. Changes to this policy',
  'sec10.text':
    'We may update this Privacy Policy to reflect changes in the Service or in regulations. We will publish the updated version with its effective date. We recommend reviewing it periodically.',
  'sec11.title': '11. Contact',
  'sec11.text':
    'If you have questions about this Privacy Policy or about the processing of your data, write to us at legal@wininterview.xyz.',
};
